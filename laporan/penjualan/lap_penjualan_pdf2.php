      ...
      <div class="body">
        ...
        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
              ...
              <tr>
                ...
                <td>
                  ...
                  while ($dataLB = mysqli_fetch_array($queryListBarang)) {
                    ...
                    $sub_total = $dataLB['jumlah'] * $tampil2['harga_jual'];
                  ?>
                    <li>
                      <?php echo $tampil2['nama_barang']; ?>
                      <br>Harga: Rp. <?php echo number_format($tampil2['harga_jual']); ?>,-
                ...
                <td>
                  ...
                  while ($dataLB = mysqli_fetch_array($queryListBarang)) {
                    ...
                    $sql2 = $koneksi->query("SELECT * FROM tb_barang WHERE kode_barang='$kode_barang'");
                    $tampil2 = $sql2->fetch_assoc();
                    $harga_total += $tampil2['harga_jual'];
                  }
          ...
          <tr>
            ...
            <td align="center" style="font-size: 15px;" colspan="2"><b><?php echo "Rp." . number_format($pemasukan); ?>,-</b></td>
          </tr>
        </table>
