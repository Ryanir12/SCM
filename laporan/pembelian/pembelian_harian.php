        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="body">
                ...
                <div class="header mb-4" align="center">
                    ...
                    <h2 align="Center">
                        Laporan Harian Pembelian Barang
                ...
                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                    ...
                    <tbody>
                        ...
                        $no = 1;
                        $pengeluaran = 0;
                        $sql1 = $koneksi->query("SELECT * FROM tb_transaksi WHERE kode_penjualan='-' AND tanggal='$tanggal1'");
                    ...
                    <tr>
                        <th style="text-align: center; font-size: 17px;" colspan="5">Total ReStok</th>
