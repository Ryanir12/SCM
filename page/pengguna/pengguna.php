    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($tampil['status'] == "Aktif") {
                                        ...
                                        echo "<a href='?page=pengguna&aksi=blokir&id=$idp' class=' btn btn-warning'> <i class='material-icons'>block </i>  Blokir</a>";
                                    } else {

                                        echo "<a href='?page=pengguna&aksi=aktif&id=$idp' class=' btn btn-success'> <i class='material-icons'>done </i>   Aktifkan</a>";
                                    }
                                    ?>
                ...
                <a href="?page=pengguna&aksi=tambah" class="btn btn-success waves-effect"><i class="material-icons">person_add </i> Tambah</a>
