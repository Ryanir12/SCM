...
$sql = $koneksi->query("select* from tb_transaksi where kode_pembelian='$kode'");
...
$sql2 = $koneksi->query("select* from tb_pembelian where kode_pembelian='$kode'");
$data2 = $sql2->fetch_assoc();
$nama1 = $data2['nama_supp'];
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="body">
                ...
                <p align="left">Nomor Pembelian : <?php echo $kode; ?></p>
                <p align="left">Tanggal Transaksi : <?php echo $tanggal; ?></p>
                <p align="left">Nama Supplier : <?php echo $nama1; ?></p>
                <p align="left">Nama Penerima : <?php echo $nama; ?></p>
                <br>

                <p align="left" style="mergin-left:20px; font-size:14px; ">Berikut nama barang yang dibeli dari supplier <b> <?php echo $nama1; ?></b> : </p>
                ...
                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                    <thead>
                        <tr>
                            ...
                            <th style="width:15%;">Harga Beli Barang </th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo "Rp." . number_format($data3['harga_beli']); ?>,- </td>
