<?php 
 ...
 $sql_barang = $koneksi->query("select * from tb_barang where kode_barang = '$kode_barang'");
    ...
    $sql2 = $koneksi->query("update tb_barang set stok=(stok - 1) where kode_barang='$kode_barang'");
