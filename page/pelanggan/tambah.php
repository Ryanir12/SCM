<?php 
		...
		$sql = $koneksi->query("select id_customer from tb_customer order by id_customer desc");
...
<?php 
	...
	if (isset($_POST['simpan'])) {
		...
		$simpan = $koneksi->query("insert into tb_customer (id_customer, nama, alamat, telpon, email)
