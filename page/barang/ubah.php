...
<?php 
		...
		$sql2 = $koneksi->query("select * from tb_barang where kode_barang = '$id'");
 ...
 ?>
          ...
          <div class="row clearfix">
            ...
            <div class="form-group">
                              ...
                              <div class="form-group">
                                  <div class="form-line">
                                      <input type="number" readonly="" name="stok" value="<?php echo $data['stok']; ?>" class="form-control" >
                                  </div>
                              </div>
...
<?php
      ...
      if (isset($_POST['simpan'])) {
          ...
          $sql = $koneksi->query("update  tb_barang set kode_barang='$barcode', nama_barang='$nama', satuan='$satuan', stok='$stok', harga_beli='$beli', harga_jual='$jual', profit='$profit' where kode_barang='$id'");
