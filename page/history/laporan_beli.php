...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                History Penjualan <b><?php echo $nama ?></b>
                            </h2>
                        ...
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                 ...
                                 <?php
                                  ...
                                  ?>
                                    <tr>
                                        ...
                                        <td>
                                           <a href="page/history/invoice.php?kode=<?php echo $kode; ?>&iduser=<?php echo $data_u['id']; ?>" target="blank" class="btn btn-warning waves-effect"><i class="material-icons">print </i>Cetak Invoice</a>
                             ...
                             <a href="page/history/cetak.php" class="btn btn-primary waves-effect" target="blank" style="margin-top: px; margin-left: 5px;"><i class="material-icons">print</i> Cetak Laporan Penjualan</a>
